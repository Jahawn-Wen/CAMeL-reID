import torch
from models import CAMeL, load_pretrained, AllGather
import torch.nn as nn
import torch.nn.functional as F


class CAMeL_Retrieval(CAMeL):
    def __init__(self, config):
        ...
        if not self.pa100k_only_img_classifier and not self.reid:
            self.mlm = config['mlm']
    ...
    def forward(self, image, text_ids, text_atts, text_ids_masked=None, masked_pos=None, masked_ids=None,
        ...
        # print("Average Diversity Score:", diversity_score.mean().item())
