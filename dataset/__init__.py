...
from dataset.reid_dataset import reid_train_dataset, reid_test_dataset
...
def create_dataset(dataset, config, evaluate=False):
    ...
    # Market1501
    reid_norm = transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])
    ...
    if dataset == 're_icfg':
        ...
        test_dataset = reid_test_dataset(config, test_transform)
        if evaluate:
            return None, None, test_dataset
        train_dataset = reid_train_dataset(config, train_transform)
