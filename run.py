...
def run(args):
    ...
    elif args.task[:4] == 'reid':
        assert os.path.exists("Market/pytorch")
        args.config = 'configs/Retrieval_reid.yaml'
        print(args.config)
        print(args.task, 'to reid')
        args.task = 'reid'
        run_retrieval(args)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', default='output/pretrained/checkpoint_31.pth', type=str, help="for fine-tuning")
